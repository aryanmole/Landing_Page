      ...
      <div className="mx-auto flex max-w-[832px] flex-col items-center gap-6 px-6 pt-[60px] pb-0">
        ...
        <section className="flex flex-col items-center gap-6 text-center pt-0">
          <motion.h1
            ...
            className="max-w-[698px] text-center text-[44px] font-medium leading-[1.05] tracking-[-1px] text-[#FFECE6] sm:text-[64px] sm:tracking-[-1.6px] lg:text-[90px] lg:leading-[90px] lg:tracking-[-2.4px]"
          >
            Products built for{" "}
            <span
          ...
          <motion.p
            ...
            className="max-w-[832px] text-base font-light leading-[1.4] text-[#B8ADA8] sm:text-xl sm:leading-7"
          >
        ...
        <section className="flex w-full flex-col items-start gap-6 pt-16 sm:pt-[80px]">
          <motion.div
            ...
            className="flex w-full items-center justify-between border-b border-[#2C2C33] pb-4"
          >
          ...
          <div className="flex w-full flex-col gap-6">
            ...
            >
              <Link
                href="/productDetails"
                className="group flex flex-col gap-6 rounded-[8px_0_0_8px] border-l-4 border-l-[#EC6229] p-6 bg-[#0B0B10]/40 cursor-pointer transition-all shadow-lg hover:bg-[#0B0B10]/70 block"
              >
            ...
            <motion.article
              ...
              viewport={{ once: true, margin: "-40px" }}
              transition={{ duration: 0.6, delay: 0.15, ease: [0.25, 0.1, 0.25, 1] }}
              className="flex flex-col md:flex-row items-start md:items-center gap-[24px] rounded-lg p-6 bg-[#0B0B10]/20"
            >
